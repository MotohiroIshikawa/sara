...
console.log("[boot] server.mjs loaded", {
  ...
  AZURE_AI_MODEL_DEPLOYMENT_REPLY: process.env.AZURE_AI_MODEL_DEPLOYMENT_REPLY,
  AZURE_AI_MODEL_DEPLOYMENT_META: process.env.AZURE_AI_MODEL_DEPLOYMENT_META,
  AZURE_AI_MODEL_DEPLOYMENT_INSTPACK: process.env.AZURE_AI_MODEL_DEPLOYMENT_INSTPACK,
